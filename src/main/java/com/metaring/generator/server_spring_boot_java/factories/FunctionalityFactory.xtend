...
«IF (inputPackage = functionality.input.springBootNativeFullyQualifiedNameForImport) !== null»
import «inputPackage»;
«ENDIF»
«ENDIF»
...
«IF (outputPackage = functionality.output.springBootNativeFullyQualifiedNameForImport) !== null && outputPackage != inputPackage»
...
«var String output=null»
    public static final CompletableFuture<«IF functionality.output !== null»«output = functionality.output.springBootType»«ELSE»Void«ENDIF»> «functionality.name.toFirstLower»(«IF functionality.input !== null»«input = functionality.input.springBootType» «inputLower = input.toFirstLower»«ENDIF») {
        return call(«functionality.name.toStaticFieldName», «functionality.name.toFirstUpper»Functionality.class, getCallingFunctionality(), «IF inputLower !== null»«inputLower»«ELSE»null«ENDIF», «IF functionality.output === null»null«ELSE»result -> result«functionality.output.getSpringBootDataOrNativeTypeFromJsonCreatorMethod»«ENDIF»);
    }

    public static final CompletableFuture<«IF functionality.output !== null»«output = functionality.output.springBootType»«ELSE»Void«ENDIF»> «functionality.name.toFirstLower»(Functionality functionality«IF functionality.input !== null», «input = functionality.input.springBootType» «inputLower = input.toFirstLower»«ENDIF») {
        return call(«functionality.name.toStaticFieldName», «functionality.name.toFirstUpper»Functionality.class, functionality, «IF inputLower !== null»«inputLower»«ELSE»null«ENDIF», «IF functionality.output === null»null«ELSE»result -> result«functionality.output.getSpringBootDataOrNativeTypeFromJsonCreatorMethod»«ENDIF»);
    }
...
«IF input !== null»    public static final CompletableFuture<«IF output !== null»«output»«ELSE»Void«ENDIF»> «functionality.name.toFirstLower»FromJson(String «inputLower»Json) {
        return callFromJson(«functionality.name.toStaticFieldName», «functionality.name.toFirstUpper»Functionality.class, getCallingFunctionality(), «inputLower»Json, «IF functionality.output === null»null«ELSE»result -> result«functionality.output.getSpringBootDataOrNativeTypeFromJsonCreatorMethod»«ENDIF»);
    }
...
«IF input !== null»    public static final CompletableFuture<«IF output !== null»«output»«ELSE»Void«ENDIF»> «functionality.name.toFirstLower»FromJson(Functionality callingFunctionality, String «inputLower»Json) {
        return callFromJson(«functionality.name.toStaticFieldName», «functionality.name.toFirstUpper»Functionality.class, callingFunctionality, «inputLower»Json, «IF functionality.output === null»null«ELSE»result -> result«functionality.output.getSpringBootDataOrNativeTypeFromJsonCreatorMethod»«ENDIF»);
    }
